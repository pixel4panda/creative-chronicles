// This was an assignment to write a program that prompts the user for a credit card number and then reports (via printf) whether it is a valid AmericanExpress, MasterCard, or Visa card number, 
// per the definitions of each’s format herein. To automate code testing the program’s output should be AMEX\n or MASTERCARD\n or VISA\n or INVALID\n.
